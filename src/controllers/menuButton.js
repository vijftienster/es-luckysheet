...
const menuButton = {
  ...
  initialMenuButton: function () {
    ...
    //sheet esSave
    $("#eswork-icon-save").click(function () {
      //添加监听事件
      method.createHookFunction("save");
    });
    //sheet esPreview
    $("#eswork-icon-preview").click(function () {
      //添加监听事件
      method.createHookFunction("preview");
    });
    //sheet leftBar
    $("#eswork-icon-left-bar").click(function () {
      console.log("#eswork-icon-left-bar", $(this));
      //添加监听事件
      luckysheetConfigsetting.showEsLeftBar =
        !luckysheetConfigsetting.showEsLeftBar;

      $(this).context.style = luckysheetConfigsetting.showEsLeftBar
    ...
    //sheet rightBar
    $("#eswork-icon-right-bar").click(function () {
      //添加监听事件
      luckysheetConfigsetting.showEsRightBar =
        !luckysheetConfigsetting.showEsRightBar;

      $(this).context.style = luckysheetConfigsetting.showEsRightBar
        ? "background:rgba(0,0,0,.06)"
        : "";
