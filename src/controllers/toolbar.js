...
export const toolbarIdMap = {
  esLeftBar: "#eswork-icon-left-bar", // 'leftbar'
  esRightBar: "#eswork-icon-right-bar", // 'rightbar'
  esSave: "#eswork-icon-save", // 'save'
  esPreview: "#eswork-icon-preview", // 'preview'
  esLeft: "#eswork-icon-left", // 'left'
  esRight: "#eswork-icon-right", // 'right'
...
export function createToolbarHtml() {
  ...
  const htmlMap = {
    esLeftBar: `<div class="luckysheet-toolbar-button luckysheet-inline-block disabled" 
    id="eswork-icon-left-bar" role="button" style="user-select: none;${
      luckysheetConfigsetting.showEsLeftBar ? "background:rgba(0,0,0,.06)" : ""
    }">
        ...
        style="user-select: none;">
            ...
            style="user-select: none;">
                <div class="luckysheet-icon luckysheet-inline-block " style="user-select: none;">
                    <div aria-hidden="true" class="es es-bar_left"
                    style="user-select: none;">
                    </div>
                </div>
            </div>
    ...
    esRightBar: `<div class="luckysheet-toolbar-button luckysheet-inline-block disabled" 
    id="eswork-icon-right-bar" role="button" style="user-select: none;${
      luckysheetConfigsetting.showEsRightBar ? "background:rgba(0,0,0,.06)" : ""
    }">
        <div class="luckysheet-toolbar-button-outer-box luckysheet-inline-block"
        style="user-select: none;">
            <div class="luckysheet-toolbar-button-inner-box luckysheet-inline-block"
            style="user-select: none;">
                <div class="luckysheet-icon luckysheet-inline-block " style="user-select: none;">
                    <div aria-hidden="true" class="es es-bar_right"
                    style="user-select: none;">
                    </div>
                </div>
            </div>
    ...
    esSave: `<div class="luckysheet-toolbar-button luckysheet-inline-block disabled" 
        id="eswork-icon-save" role="button" style="user-select: none;">
            <div class="luckysheet-toolbar-button-outer-box luckysheet-inline-block"
            style="user-select: none;">
                <div class="luckysheet-toolbar-button-inner-box luckysheet-inline-block"
                style="user-select: none;">
                    <div class="luckysheet-icon luckysheet-inline-block " style="user-select: none;">
                        <div aria-hidden="true" class="es es-save"
                        style="user-select: none;">
                        </div>
                    </div>
                </div>
    ...
    esPreview: `<div class="luckysheet-toolbar-button luckysheet-inline-block disabled"
        id="eswork-icon-preview" role="button" style="user-select: none;">
            <div class="luckysheet-toolbar-button-outer-box luckysheet-inline-block"
            style="user-select: none;">
                <div class="luckysheet-toolbar-button-inner-box luckysheet-inline-block"
                style="user-select: none;">
                    <div class="luckysheet-icon luckysheet-inline-block " style="user-select: none;">
                        <div aria-hidden="true" class="es es-preview"
                        style="user-select: none;">
                        </div>
                    </div>
                </div>
